...
class phpbb_privmsgs_delete_user_pms_test extends phpbb_database_test_case
{
	...
	*/
	public function test_delete_user_pms($delete_user, $remaining_privmsgs, $remaining_privmsgs_to)
	{
		...
		$phpbb_container->set('attachment.manager', new \phpbb\attachment\drivers\local\delete(new \phpbb\config\config(array()), $db, new \phpbb_mock_event_dispatcher(), new \phpbb\filesystem\filesystem(), new \phpbb\attachment\drivers\local\resync($db), $phpbb_root_path));
