...
class phpbb_functions_user_delete_user_test extends phpbb_database_test_case
{
	...
	protected function setUp()
	{
		...
		$phpbb_container->set('attachment.manager', new \phpbb\attachment\drivers\local\delete($config, $db, new \phpbb_mock_event_dispatcher(), new \phpbb\filesystem\filesystem(), new \phpbb\attachment\drivers\local\resync($db), $phpbb_root_path));
		$phpbb_container->set(
			'auth.provider.db',
